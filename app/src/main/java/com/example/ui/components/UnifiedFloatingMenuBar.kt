...
fun UnifiedFloatingMenuBar(
  ...
  Box(
    ...
    // Backdrop dismiss if add actions are expanded
    ...
    Column(
      ...
      // Expanded mini action buttons above the floating bar
      AnimatedVisibility(
        ...
        Row(
          ...
          FloatingMiniAction(
            ...
            label = stringResource(R.string.action_checklist),
            testTag = "floating_action_checklist",
            onClick = {
              isAddMenuExpanded = false
          ...
          FloatingMiniAction(
            ...
            testTag = "floating_action_note",
            onClick = {
              isAddMenuExpanded = false
              onCreateStandardNote()
            }
          )
        }
      }

      // Streamlined Floating Pill Bar (ViewMode + Sort + Add)
      Surface(
...
@Composable
private fun FloatingMiniAction(
  icon: ImageVector,
  label: String,
  testTag: String,
  onClick: () -> Unit
